...
function runFixture(sourceDir, resultDir, testConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        yield fse.emptyDir(resultDir);
        yield fse.copy(sourceDir, resultDir);
        // Top-Level Integration Test! Test the CLI interface directly.
        return yield util_1.exec(resultDir, 'node', [
            modulizerBinPath,
            '--out',
            '.',
            '--force',
