 ...
 * export graph.
 */
function addA11ySuiteIfUsed(program, a11ySuiteUrl) {
    let isFound = false;
    ...
    program.body.unshift(jsc.importDeclaration([jsc.importSpecifier(jsc.identifier('a11ySuite'))], jsc.literal(a11ySuiteUrl)));
    return true;
}
exports.addA11ySuiteIfUsed = addA11ySuiteIfUsed;
//# sourceMappingURL=add-a11y-suite-if-used.js.map