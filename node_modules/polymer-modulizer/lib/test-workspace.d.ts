...
export declare function testWorkspace(localConversionMap: Map<string, string>, options: WorkspaceTestSettings): Promise<WorkspaceRepo[]>;
export declare function testWorkspaceInstallOnly(localConversionMap: Map<string, string>, options: WorkspaceTestSettings): Promise<WorkspaceRepo[]>;
export {};
