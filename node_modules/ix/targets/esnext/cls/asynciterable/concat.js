goog.module('targets.esnext.cls.asynciterable.concat'); exports = {}; var module = {id: 'targets/esnext/cls/asynciterable/concat.js'};/**
...
class ConcatAllAsyncIterable extends asynciterable_1.AsyncIterableX {
    ...
    async *[Symbol.asyncIterator]() {
        for await (let /** @type {!AsyncIterable<TSource>} */ outer of this._source) {
            for await (let /** @type {TSource} */ item of outer) {
                yield item;
            }
        }
    }
