goog.module('targets.esnext.cls.asynciterable.orderby'); exports = {}; var module = {id: 'targets/esnext/cls/asynciterable/orderby.js'};/**
...
var sorter_1 = goog.require('targets.esnext.cls.internal.sorter');
...
class OrderedAsyncIterableBaseX extends asynciterable_1.AsyncIterableX {
    ...
    async *[Symbol.asyncIterator]() {
        const /** @type {!Array<TSource>} */ array = await toarray_1.toArray(this._source);
