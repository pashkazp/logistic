goog.module('targets.es2015.cls.asynciterable.innerjoin'); exports = {}; var module = {id: 'targets/es2015/cls/asynciterable/innerjoin.js'};/**
                ...
                for (var _a = __asyncValues(this._outer), _b; _b = yield __await(_a.next()), !_b.done;) {
                    ...
                    if (map.has(outerKey)) {
                        for (let /** @type {?} */ innerElement of ((map.get(outerKey)))) {
                            yield yield __await(this._resultSelector(outerElement, innerElement));
                        }
                    }
                }
            }
