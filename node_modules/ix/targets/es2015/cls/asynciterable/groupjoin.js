goog.module('targets.es2015.cls.asynciterable.groupjoin'); exports = {}; var module = {id: 'targets/es2015/cls/asynciterable/groupjoin.js'};/**
...
var from_1 = goog.require('targets.es2015.cls.asynciterable.from');
...
class GroupJoinAsyncIterable extends asynciterable_1.AsyncIterableX {
    ...
    [Symbol.asyncIterator]() {
        return __asyncGenerator(this, arguments, function* _a() {
            const /** @type {!Map<TKey, !Array<?>>} */ map = yield __await(_grouping_1.createGrouping(this._inner, this._innerSelector, identity_1.identity));
            try {
                for (var _a = __asyncValues(this._outer), _b; _b = yield __await(_a.next()), !_b.done;) {
                    let /** @type {TOuter} */ outerElement = yield __await(_b.value);
                    const /** @type {TKey} */ outerKey = yield __await(this._outerSelector(outerElement));
                    ...
                    yield yield __await(this._resultSelector(outerElement, from_1.from(innerElements)));
                }
            }
