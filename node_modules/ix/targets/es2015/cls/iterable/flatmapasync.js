goog.module('targets.es2015.cls.iterable.flatmapasync'); exports = {}; var module = {id: 'targets/es2015/cls/iterable/flatmapasync.js'};/**
        ...
        return __asyncGenerator(this, arguments, function* _a() {
            try {
                for (var /** @type {!AsyncIterable<TSource>} */ _a = __asyncValues(/** @type {!AsyncIterable<TSource>} */ ((this._source))), _b; _b = yield __await(_a.next()), !_b.done;) {
                    ...
                    try {
                        for (var /** @type {!AsyncIterable<TResult>} */ _c = __asyncValues(/** @type {!AsyncIterable<TResult>} */ ((this._selector(outer)))), _d; _d = yield __await(_c.next()), !_d.done;) {
                            let /** @type {TResult} */ inner = yield __await(_d.value);
                            yield inner;
                        }
                    }
                        ...
                        try {
                            if (_d && !_d.done && (_e = _c.return)) yield __await(_e.call(_c));
                        }
                ...
                try {
                    if (_b && !_b.done && (_f = _a.return)) yield __await(_f.call(_a));
                }
