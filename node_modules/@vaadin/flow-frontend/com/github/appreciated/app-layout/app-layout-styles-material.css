html {
    ...
    --lumo-box-shadow-s: var(--shadow-elevation-2dp_-_box-shadow);
    ...
    --app-layout-background: var(--material-base-color);
    ...
    --app-layout-drawer-shadow: var(--shadow-elevation-2dp_-_box-shadow);
    --app-layout-drawer-background-base-color: var(--material-background-color);
    --app-layout-drawer-background-color: transparent;
    --app-layout-drawer-submenu-background-color: var(--material-divider-color);
    ...
    --app-layout-notification-shadow: var(--shadow-elevation-2dp_-_box-shadow);
