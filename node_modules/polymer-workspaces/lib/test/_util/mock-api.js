...
exports.testApiToken = 'XXXXXXXXXXXXXXXXXXXXXXXX';
function setup() {
    ...
    nock('https://api.github.com')
        ...
        .query({ access_token: exports.testApiToken })
        .reply(200, [
        {
        ...
        Status: '200 OK',
        Link: '<https://api.github.com/organizations/11639138/repos?page=2>; rel="next", <https://api.github.com/organizations/11639138/repos?page=5>; rel="last"'
    });
    nock('https://api.github.com')
        .persist()
        .get('/organizations/11639138/repos')
        .query({ page: 2, access_token: exports.testApiToken })
        .reply(200, [], {
        Status: '200 OK',
        Link: '<https://api.github.com/organizations/11639138/repos?page=1>; rel="last", <https://api.github.com/organizations/11639138/repos?page=1>; rel="first", <https://api.github.com/organizations/11639138/repos?page=1>; rel="prev"'
    });
    nock('https://api.github.com')
        .persist()
