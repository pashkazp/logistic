...
public class AllRegisteredManager extends AbstractSelectedUsersManager<UsersGridViewer>
     ...
     */
    @Autowired
    public AllRegisteredManager(UsersGridViewer usersGridViewer, UserEditor userEditor) {
