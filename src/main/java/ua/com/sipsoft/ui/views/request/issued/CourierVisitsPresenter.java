...
/**
 * The Class CourierVisitsPresenter.
 * 
 * @author Pavlo Degtyaryev
 */
@Slf4j
public class CourierVisitsPresenter extends VerticalLayout {
	 ...
	 */
	public CourierVisitsPresenter(CourierVisit visit) {
...
//		Label creationDate = new Label(visit.getCreationDate().format(formatter));
		...
		iconInfo.addClickListener(event -> ConfirmDialog
				...
				.withMessage(new HistoryEventViever<>(new Grid<>(CourierVisitEvent.class),
